 ...
 *
 * In this sample, the user can touch one of two images. Touching an image zooms it in, covering
 * the entire activity content area. Touching the zoomed-in image hides it.
 */
public class ZoomActivity extends FragmentActivity {
     ...
     *   3. Animate each of four positioning/sizing properties (X, Y, SCALE_X, SCALE_Y)
